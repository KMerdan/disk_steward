...
final class DiskStewardEndpointTests: XCTestCase {
    ...
    func testWritesCoalesceWithinBoundsAndOverloadSignalsFallback() async throws {
        ...
        let first = try XCTUnwrap(normalizer.normalize(fixture.raw(path: "/watched/a", sequence: 1, observedAt: base), scope: fixture.scope, gapBefore: false))
        let second = try XCTUnwrap(normalizer.normalize(fixture.raw(path: "/watched/a", sequence: 2, observedAt: base.addingTimeInterval(0.2)), scope: fixture.scope, gapBefore: false))
