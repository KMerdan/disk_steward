...
def main():
    ...
    parser.add_argument("--variant", choices=["baseline", "path-index"], default="baseline")
    ...
    benchmark = supervise(["/usr/bin/nice", "-n", "10", "/usr/bin/xcrun", "xctest", "-XCTest",
                           "PerformanceTests.ScaleBenchmarkTests/testOptInProductionScan", str(bundle)],
