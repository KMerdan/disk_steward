...
final class StatusItemController: NSObject, NSPopoverDelegate {
    ...
    override init() {
        ...
        agentAccess = MCPAccessController(settingsStore: accessSettings) {
            ...
            let backend = try AppEvidenceQueryBackend(databaseURL: supportDirectory.appending(path: "evidence.sqlite"), retentionPolicyProvider: { try await MainActor.run { try settingsStore.settings.retentionPolicy() } })
