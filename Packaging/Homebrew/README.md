...
The canonical cask is [`Casks/disk-steward.rb`](Casks/disk-steward.rb). It resolves the immutable, notarized Disk Steward 1.1.0 release archive and pins its SHA-256 digest.
